function operstruct = makeSurfaceToSurfaceYukawaOperators(surf, surf2)

if nargin < 2
  [V,K,W] = genPointYukawaMatrices(surf.points, surf.normals, ...
				 surf.weights);
else
  [V,K,W] = genPointYukawaMatrices(surf.points, surf.normals, surf.weights, ...
				 surf2.points, surf2.normals, surf2.weights);
end
